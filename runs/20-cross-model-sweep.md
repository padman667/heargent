...
- **Row 4a — partial-closure-with-residuals** at all three N-scopes (M11a-alone N=5; M10b+M11a N=8; combined N=10 primary scope). V2-Opus failure rate **20%** (95% CI [2.5%, 55.6%]) vs V2-3B **50%** (95% CI [18.7%, 81.3%]) — 30 pp reduction at point estimate, non-overlapping point estimates but partially overlapping CIs.
...
| V2-Opus (M11a carry-forward) | 2/10 | 20.0% | [2.5%, 55.6%] | [observed] | -30 pp | — | NO | — |
